...
public final class StageInstanceActionTypeHandler extends GuildAuditLogEntryCreateEventActionTypeHandler {
    ...
    @Inject
    public StageInstanceActionTypeHandler(@ConfigProperty(name = "stage.instance.action.log.channel") @NonNull String stageInstanceActionLogChannel) {
    ...
    private void performChecksThenBuildAndSendEmbed(@NonNull GuildAuditLogEntryCreateEvent event, @NonNull EmbedBuilder embedBuilder) {
        ...
        TextChannel sendingChannel = event.getGuild().getTextChannelById(stageInstanceActionLogChannel);
