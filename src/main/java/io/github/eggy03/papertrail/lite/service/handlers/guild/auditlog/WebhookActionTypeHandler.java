...
import io.github.eggy03.papertrail.lite.utils.guild.auditlog.WebhookUtils;
...
public final class WebhookActionTypeHandler extends AbstractGuildAuditLogEntryCreateEventActionTypeHandler {
    ...
    @Inject
    public WebhookActionTypeHandler(@NonNull PaperTrailConfig paperTrailConfig, @NonNull EmbedSendingService embedSendingService) {
    ...
    public void onWebhookCreate(@NonNull GuildAuditLogEntryCreateEvent event) {
        ...
        embedSendingService.checkAndSend(event, eb, paperTrailConfig.guild().auditLog().webhookActionTypeLogChannel());
    }
