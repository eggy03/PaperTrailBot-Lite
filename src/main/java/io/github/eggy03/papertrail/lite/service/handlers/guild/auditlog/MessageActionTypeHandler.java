...
public final class MessageActionTypeHandler extends AbstractGuildAuditLogEntryCreateEventActionTypeHandler {
    ...
    @Inject
    public MessageActionTypeHandler(@NonNull PaperTrailConfig paperTrailConfig, @NonNull EmbedSendingService embedSendingService) {
    ...
    public void onMessageDelete(@NonNull GuildAuditLogEntryCreateEvent event) {
        ...
        embedSendingService.checkAndSend(event, eb, paperTrailConfig.guild().auditLog().messageActionTypeLogChannel());
    }
